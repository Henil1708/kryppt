    ...
    <div className='flex  w-full justify-center items-center'>
      <div className="flex mf:flex-row flex-col items-start justify-between md:p-20 p-12 px-4">
        <div className="flex flex-1 justify-start flex-col mf:mr-10">
          ...
          {!currentAccount && <button className='flex flex-row justify-center items-center my-5 text-white bg-[#2952e3] cursor-pointer p-3 rounded-full hover:bg-[#2546bd]' type='button' onClick={connectWallet}>
        ...
        <div className='flex flex-col flex-1 items-center justify-start w-full mf:mt-0 mt-10'>
          <div className="p-3 justify-end items-start rounded-xl flex-col h-40 sm:w-72 w-full my-5 eth-card white-glassmorphism">
            <div className="flex justify-between flex-col w-full h-full ">
              ...
              <div>
                <p className='text-white font-medium text-sm '>{currentAccount ? <>{shortenAddress(currentAccount)}</>:"Address"}</p>
